...
final class DemoCustomersSeeder
{
    ...
    private function seedCustomers(int $instanceId, array $groups): void
    {
        $customers = [
            ...
            ['code' => 'DEMO-CL-005', 'name' => 'CODIFARM', 'email' => 'codifarm@saphir.ci', 'phone' => '+225 07 05 05 05', 'city' => 'Abidjan', 'country' => 'CI', 'group' => '[DEMO] Grossistes VIP', 'company_name' => 'CODIFARM', 'credit_limit' => 15000000],
