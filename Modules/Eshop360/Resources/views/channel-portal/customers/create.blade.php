...
<div class="mb-4">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h4 class="fw-bold mb-1">{{ __('Nouveau client') }}</h4>
            <p class="text-muted mb-0">{{ __('Ajouter un client pour ce canal') }}</p>
        </div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="{{ route('eshop360.channel-portal.customers.store', [$slug, $channelKey]) }}">
            @csrf
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="number" name="credit_limit" class="form-control @error('credit_limit') is-invalid @enderror"
                               value="{{ old('credit_limit', 0) }}" min="0" step="1">
