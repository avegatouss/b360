<x-dashboard::layouts.master
    :title="__('Profits & Pertes') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Profits & Pertes')">
        ...
        <div class="content">
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>{{ __('Profits & Pertes') }}</h4>
                        <h6>{{ __('Bilan des revenus et depenses') }}</h6>
                    </div>
                </div>
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4 col-lg">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            <p class="text-muted small mb-1">{{ __('Coût des ventes (COGS)') }}</p>
                ...
                <div class="col-md-4 col-lg">
                    <div class="card h-100 border-0 bg-{{ $netColor }}-transparent shadow-sm">
                        <div class="card-body text-center">
                            <p class="text-muted small mb-1">{{ __('Résultat net') }}</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table">
                                <tbody>
                                    ...
                                    @empty
                                    <tr><td colspan="2" class="text-center text-muted">{{ __('Aucune donnee') }}</td></tr>
                                    @endforelse
                                </tbody>
                                <tfoot>
