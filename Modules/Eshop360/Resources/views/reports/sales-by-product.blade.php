<x-dashboard::layouts.master
    :title="__('Ventes par produit') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Ventes par produit')">


            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        <h4>{{ __('Ventes par produit') }}</h4>
                        <h6>{{ __('Repartition du chiffre d\'affaires par produit') }}</h6>
                    </div>
                </div>
