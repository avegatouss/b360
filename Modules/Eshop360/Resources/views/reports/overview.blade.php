        ...
        <div class="content">
            <div class="page-header">
                <div class="add-item d-flex">
                    <div class="page-title">
                        ...
                        <h6>{{ __('Resume des indicateurs cles') }}</h6>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body d-flex align-items-center">
                            <div class="dash-count">
                                ...
                                <h5 class="text-muted">{{ __('Ventes totales') }}</h5>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body d-flex align-items-center">
                            <div class="dash-count">
                                ...
                                <h5 class="text-muted">{{ __('Commandes') }}</h5>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body d-flex align-items-center">
                            <div class="dash-count">
                                ...
                                <h5 class="text-muted">{{ __('Depenses') }}</h5>
                            </div>
                            <div class="ms-auto">
                    ...
                    <div class="card">
                        <div class="card-body d-flex align-items-center">
                            <div class="dash-count">
                                ...
                                <h5 class="text-muted">{{ __('Benefice net') }}</h5>
                            </div>
                            <div class="ms-auto">
            ...
            <div class="card table-list-card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h5 class="mb-3">{{ __('Top produits') }}</h5>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead><tr><th>{{ __('Produit') }}</th><th>{{ __('Qte vendue') }}</th><th>{{ __('CA') }}</th></tr></thead>
                                    <tbody>
                                        ...
                                        @empty
                                        <tr><td colspan="3" class="text-center text-muted">{{ __('Aucune donnee') }}</td></tr>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="col-md-6">
                            <h5 class="mb-3">{{ __('Top clients') }}</h5>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead><tr><th>{{ __('Client') }}</th><th>{{ __('Commandes') }}</th><th>{{ __('Total') }}</th></tr></thead>
                                    <tbody>
