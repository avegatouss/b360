<x-dashboard::layouts.master
    :title="__('Invoice Settings') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
                                ...
                                <div class="card-body ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="logo-info me-0 mb-3 mb-md-0">
                                                        <h6>{{ __('Invoice Logo') }}</h6>
                                                        <p>{{ __('Upload Logo of your Company to display in Invoice') }}</p>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                            ...
                                                            <div class="mb-3 mb-md-0">
                                                                <div class="image-upload mb-0">
                                                                    ...
                                                                    <div class="image-uploads">
                                                                        <h4><i data-feather="upload"></i>{{ __('Upload Photo') }}</h4>
                                                                    </div>
                                                                </div>
                                                                <span>{{ __('For better preview recommended size is 450px x 450px. Max size 5mb.') }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="localization-info">
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="setting-info">
                                                    <h6>{{ __('Invoice Prefix') }}</h6>
                                                    <p>{{ __('Add prefix to your invoice') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="setting-info">
                                                    <h6>{{ __('Invoice Due') }}</h6>
                                                    <p>{{ __('Select due date to display in Invoice') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="setting-info">
                                                    <h6>{{ __('Invoice Round Off') }}</h6>
                                                    <p>{{ __('Value Roundoff in Invoice') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-sm-4">
                                                <div class="setting-info">
                                                    <h6>{{ __('Show Company Details') }}</h6>
                                                    <p>{{ __('Show / Hide Company Details in Invoice') }}</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="setting-info">
                                                    <h6>{{ __('Invoice Header Terms') }}</h6>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="mb-3">
                                                    <textarea  rows="4" class="form-control" placeholder="{{ __('Type your message') }}"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
