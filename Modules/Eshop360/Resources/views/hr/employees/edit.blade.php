<x-dashboard::layouts.master
    :title="__('Edit Employee') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Edit Employee')">

<div class="page-header">
    <div class="page-title">
        <h4 class="fw-bold">{{ __('Edit Employee') }}</h4>
        <h6>{{ __('Update employee information') }}</h6>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('eshop360.hr.employees.update', [$instance->slug ?? '', $employee]) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('Salary') }}<span class="text-danger">*</span></label>
