<x-dashboard::layouts.master
    :title="__('Create Employee') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Create Employee')">

<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4 class="fw-bold">{{ __('Create Employee') }}</h4>
            <h6>{{ __('Add a new employee to your team') }}</h6>
        </div>
    </div>
    <div class="page-btn">
