<x-dashboard::layouts.master
    :title="'Account: ' . ($account->name ?? '') . ' — ' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            ...
            <h6>Account details and transactions</h6>
        </div>
    </div>
    <div class="page-btn">
        <a href="{{ route('eshop360.finance.accounts.index', $instance->slug ?? '') }}" class="btn btn-secondary"><i class="ti ti-arrow-left me-1"></i>Back</a>
    </div>
</div>
    ...
    <div class="col-md-4">
        ...
        <div class="card bg-primary text-white">
            <div class="card-body text-center">
                <h6 class="text-white-50">Current Balance</h6>
