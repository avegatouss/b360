...
<div class="page">
    ...
    <table class="items">
        <thead><tr style="background-color:#1e40af; color:#fff;"><th style="background-color:#1e40af; color:#fff; padding:10px 12px;">#</th><th style="background-color:#1e40af; color:#fff; padding:10px 12px;">{{ __('Designation') }}</th><th class="text-center">{{ __('Qte') }}</th><th class="text-right">{{ __('P.U.') }}</th><th class="text-right">{{ __('TVA') }}</th><th class="text-right">{{ __('Total') }}</th></tr></thead>
        <tbody>
