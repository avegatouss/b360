<x-dashboard::layouts.master
    :title="__('Nouveau canal de distribution') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Nouveau canal de distribution')">

<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4 class="fw-bold">{{ __('Nouveau canal de distribution') }}</h4>
            <h6>{{ __('Configurer un nouveau canal de vente') }}</h6>
        </div>
    </div>
    <div class="page-btn">
        ...
        <form action="{{ route('eshop360.channels.store', $instance->slug ?? '') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <small class="form-text text-muted">{{ __('Lettres minuscules, chiffres et tirets uniquement (ex: mon-canal-01)') }}</small>
            ...
            <hr class="my-4">
            <h5 class="mb-3"><i class="ti ti-percentage me-1"></i>{{ __('Taux et marges') }}</h5>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('Taux de marge') }}<span class="text-danger">*</span></label>
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">{{ __('Taux d\'achat') }}<span class="text-danger">*</span></label>
            ...
            <hr class="my-4">
            <h5 class="mb-3"><i class="ti ti-chart-pie me-1"></i>{{ __('Répartition des parts') }}</h5>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <label class="form-label">{{ __('Part dette') }}<span class="text-danger">*</span></label>
                ...
                <div class="col-md-4 mb-3">
                    <label class="form-label">{{ __('Part canal') }}<span class="text-danger">*</span></label>
                ...
                <div class="col-md-4 mb-3">
                    <label class="form-label">{{ __('Part propriétaire') }}<span class="text-danger">*</span></label>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i>{{ __('Créer le canal') }}</button>
