<x-dashboard::layouts.master
    :title="'Import Orders — ' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
...
<div class="page-header">
    <div class="add-item d-flex">
        <div class="page-title">
            <h4 class="fw-bold">Import Orders</h4>
            <h6>Manage your import orders</h6>
        </div>
    </div>
    <ul class="table-top-head">
        ...
        <li><a data-bs-toggle="tooltip" data-bs-placement="top" title="Refresh"><i data-feather="rotate-ccw" class="feather-rotate-ccw"></i></a></li>
    </ul>
    <div class="page-btn">
        <a href="{{ route('eshop360.imports.create', $instance->slug ?? '') }}" class="btn btn-primary"><i data-feather="plus-circle" class="me-1"></i>New Import Order</a>
    </div>
</div>
        ...
        <div class="d-flex table-dropdown my-xl-auto right-content align-items-center flex-wrap row-gap-3">
            <div class="dropdown me-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end p-3">
                    ...
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Draft</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Ordered</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Shipped</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Received</a></li>
                </ul>
            </div>
            <div class="dropdown">
                <a href="javascript:void(0);" class="dropdown-toggle btn btn-white btn-md d-inline-flex align-items-center" data-bs-toggle="dropdown">Shipping Type</a>
                <ul class="dropdown-menu dropdown-menu-end p-3">
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">All</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Air</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Sea</a></li>
                    <li><a href="javascript:void(0);" class="dropdown-item rounded-1">Land</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <table class="table datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ ucfirst($import->shipping_type ?? '—') }}</td>
                        ...
                        <td class="action-table-data">
                            <div class="edit-delete-action">
                                ...
                                <form action="{{ route('eshop360.imports.destroy', [$instance->slug ?? '', $import]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                                    @csrf @method('DELETE')
                    ...
                    @empty
                    <tr><td colspan="9" class="text-center text-muted">No import orders found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
