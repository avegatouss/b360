<x-dashboard::layouts.master
    :title="__('Product Expiry Report') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Product Expiry Report')">

<div class="mb-4">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('product-report')}}">Product Report</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('product-expiry-report')}}">Product Expiry Report</a>
                    </li>
                    <li class="nav-item">
            ...
            <div>
                ...
                <div class="card">
                    <div class="card-body pb-1">
                        <form action="{{url('product-expiry-report')}}">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ __('25 Dec 2024') }}</td>
                                        <td>{{ __('21 Dec 2026') }}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>{{ __('26 Dec 2024') }}</td>
                                        <td>{{ __('22 Dec 2026') }}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>{{ __('30 Dec 2024') }}</td>
                                        <td>{{ __('25 Dec 2026') }}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>{{ __('28 Dec 2024') }}</td>
                                        <td>{{ __('26 Dec 2026') }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ __('15 Dec 2024') }}</td>
                                        <td>{{ __('30 Dec 2026') }}</td>
                                    </tr>
                                    <tr>
