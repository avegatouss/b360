<x-dashboard::layouts.master
    :title="__('Sold Stock') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Sold Stock')">
...
<div class="mb-4">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{url('sold-stock')}}">Sold Stock</a>
                    </li>
                </ul>
            </div>
            <div>
                <div class="page-header">
                    <div class="add-item d-flex">
                        <div class="page-title">
                            <h4>{{ __('Sold Stock') }}</h4>
                            <h6>{{ __('View Reports of Sold Stock') }}</h6>
                        </div>
                    </div>
