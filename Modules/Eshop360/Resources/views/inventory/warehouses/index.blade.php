<x-dashboard::layouts.master
    :title="__('Warehouses') . ' -' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
    :pageTitle="__('Warehouses')">

<div class="page-header">
    <div class="page-title me-auto">
        <h4 class="fw-bold">{{ __('Warehouses') }}</h4>
        <h6>{{ __('Manage storage locations and counters') }}</h6>
    </div>
</div>
        ...
        <form method="GET" action="{{ route('eshop360.warehouses.index', $instance->slug ?? '') }}" class="row g-3">
            <div class="col-md-6">
                ...
                <input
                    ...
                    class="form-control"
                    placeholder="{{ __('Name, code or city') }}">
            </div>
            <div class="col-md-3">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4">{{ __('No warehouses found.') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
