<x-dashboard::layouts.master
    :title="'Add Product — ' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
...
<div class="page-header">
            ...
            @endif
            <form action="{{ route('eshop360.products.store', $instance->slug ?? '') }}" method="POST" enctype="multipart/form-data" class="add-product-form">
                @csrf
                                ...
                                <div class="accordion-body border-top">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-12">
                                            <div class="mb-3 list position-relative">
                                                ...
                                                <input type="text" class="form-control list" name="sku" value="{{ old('sku') }}">
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select" name="unit">
                                                        ...
                                                        <option value="dz" {{ old('unit') == 'dz' ? 'selected' : '' }}>dz</option>
                                                        <option value="bx" {{ old('unit') == 'bx' ? 'selected' : '' }}>bx</option>
                                                    </select>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="summer-description-box">
                                            ...
                                            <textarea name="description" id="summernote" class="summernote">{{ old('description') }}</textarea>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select class="select" name="tax_rate">
                                                            ...
                                                            @foreach($taxRates ?? [] as $rate)
                                                                <option value="{{ $rate->id ?? $rate }}" {{ old('tax_rate') == ($rate->id ?? $rate) ? 'selected' : '' }}>{{ $rate->name ?? $rate }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-sm-6 col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" type="number" step="0.01" name="discount_value" value="{{ old('discount_value') }}">
                    ...
                    <div class="accordion-item border mb-4">
                        <h2 class="accordion-header" id="headingSpacingSaphir">
                            <div class="accordion-button collapsed bg-white" data-bs-toggle="collapse"
                                ...
                                <span class="fw-bold">Tarification SAPHIR &amp; Données Pharmaceutiques</span>
                            </div>
                        </h2>
                        <div id="SpacingSaphir" class="accordion-collapse collapse" aria-labelledby="headingSpacingSaphir">
                            <div class="accordion-body border-top">
                                <h6 class="text-muted mb-3">Niveaux de prix</h6>
                                <div class="row g-3 mb-4">
                                    <div class="col-md-3">
                                        <label class="form-label">Prix d'achat usine (PA Usine)</label>
                                        <input type="number" step="0.0001" class="form-control" name="purchase_price_factory"
                                               value="{{ old('purchase_price_factory') }}" placeholder="0.0000">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">PGHT</label>
                                        <input type="number" step="0.0001" class="form-control" name="pght"
                                               value="{{ old('pght') }}" placeholder="0.0000">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Prix grossiste</label>
                                        <input type="number" step="0.01" class="form-control" name="wholesale_price"
                                               value="{{ old('wholesale_price') }}" placeholder="0.00">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Prix pharmacie</label>
                                        <input type="number" step="0.01" class="form-control" name="pharmacy_price"
                                               value="{{ old('pharmacy_price') }}" placeholder="0.00">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Prix vente CODIFARM</label>
                                        <input type="number" step="0.0001" class="form-control" name="sale_price_codifarm"
                                               value="{{ old('sale_price_codifarm') }}" placeholder="0.0000">
                                    </div>
                                    <div class="col-md-3">
                                        <label class="form-label">Qté min. grossiste</label>
                                        <input type="number" min="1" class="form-control" name="min_qty_wholesale"
                                               value="{{ old('min_qty_wholesale', 1) }}">
                                    </div>
                                </div>
                                <h6 class="text-muted mb-3">Données pharmaceutiques</h6>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="form-label">DCI (Dénomination Commune Internationale)</label>
                                        <input type="text" class="form-control" name="dci"
                                               value="{{ old('dci') }}" placeholder="Ex: Amoxicilline">
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label">Dosage</label>
                                        <input type="text" class="form-control" name="dosage"
                                               value="{{ old('dosage') }}" placeholder="Ex: 500mg">
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="packaging"
                                               value="{{ old('packaging') }}" placeholder="Ex: Boite de 20">
                                    </div>
                                    <div class="col-md-3">
