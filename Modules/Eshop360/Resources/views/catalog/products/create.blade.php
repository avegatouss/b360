<x-dashboard::layouts.master
    :title="__('Add Product') . ' —' . ($instance->name ?? $instance->slug ?? 'B360')"
    :instance="$instance"
                                ...
                                <div class="accordion-body border-top">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3 list position-relative">
                                                    <label class="form-label">{{ __('Item Barcode') }}<span class="text-danger ms-1">*</span></label>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-sm-6 col-12">
                                                    <div class="mb-3">
                                                        <label class="form-label">{{ __('Tax') }}<span class="text-danger ms-1">*</span></label>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="select">
                                                        ...
                                                        <option>{{ __('Replacement Warranty') }}</option>
