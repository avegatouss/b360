...
<body>
                ...
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                    ...
                    <li class="dropdown topbar-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end py-0">
                            ...
                            <form method="POST" action="{{ isset($instance) ? route('instance.logout', $instance->slug) : route('logout') }}" id="sidebar-logout-form">
                                    @csrf
                                    <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="document.getElementById('sidebar-logout-form').submit();">
    ...
    {{-- <div class="startbar d-print-none">
        <!--start brand-->
        <div class="brand">
            <a href="{{ isset($instance) ? route('dashboard.instance', $instance->slug) : '/' }}" class="logo">
                <span>
                        ...
                        <div class="col-12">
                            <div class="page-title-box d-flex justify-content-between align-items-center flex-wrap gap-2">
                                ...
                                {{-- <div>
                                    ...
                                    @if(isset($instance))
                                        <h6 class="text-muted mt-1 mb-0">{{ $instance->name ?? $instance->slug }}</h6>
                                    @endif
                                </div> --}}

                                <div class="d-flex align-items-center gap-2">
                                    @if(isset($instance))
                                        <span class="badge bg-soft-primary text-primary fw-semibold px-2 py-1" style="font-size: 0.75rem;">
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col">
                                                ...
                                                <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="las la-trending-up"></i>8.5%</span> New Sessions Today</p>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col">
                                                ...
                                                <h3 class="my-1 fs-20">00:18</h3>
                                                <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="las la-trending-up"></i>1.5%</span> Weekly Avg.Sessions</p>
                                            </div>
                                            <div class="col-auto align-self-center">
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col">
                                                ...
                                                <h3 class="my-1 fs-20">$2400</h3>
                                                <p class="mb-0 text-truncate text-muted"><span class="text-danger"><i class="las la-trending-down"></i>35%</span> Bounce Rate Weekly</p>
                                            </div>
                                            <div class="col-auto align-self-center">
                                    ...
                                    <div class="card-body">
                                        <div class="row d-flex justify-content-center">
                                            <div class="col">
                                                ...
                                                <h3 class="my-1 fs-20">85000</h3>
                                                <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="las la-trending-up"></i>10.5%</span> Completions Weekly</p>
                                            </div>
                                            <div class="col-auto align-self-center">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body px-0">
                                <ul class="list-group list-group-flush mb-n3">
                                    <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/logos/lang-logo/chatgpt.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                            </div>
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/logos/lang-logo/gitlab.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                            </div>
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/logos/lang-logo/meta.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                            </div>
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <img src="assets/images/logos/lang-logo/slack.png" height="30" class="me-2 align-self-center rounded" alt="...">
                                            </div>
                                            <div class="flex-grow-1 ms-2 text-truncate">
                                    ...
                                    <div class="activity">
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <i class="las la-user-clock bg-primary-subtle text-primary"></i>
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Donald</span>
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <i class="las la-stream bg-primary-subtle text-primary"></i>
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Lucy Peterson</span>
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <img src="assets/images/users/avatar-5.jpg" alt="" class="rounded-circle thumb-md">
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Joseph Rust</span>
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <i class="las la-business-time bg-primary-subtle text-primary"></i>
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Donald</span>
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <i class="las la-exclamation-triangle bg-primary-subtle text-primary"></i>
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Lucy Peterson</span>
                                        ...
                                        <div class="activity-info">
                                            <div class="icon-info-activity">
                                                <img src="assets/images/users/avatar-4.jpg" alt="" class="rounded-circle thumb-md">
                                            </div>
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 fs-13 w-75"><span>Joseph Rust</span>
...
<!-- Mirrored from mannatthemes.com/dastone-bs5/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 May 2026 15:52:27 GMT -->
</html>
